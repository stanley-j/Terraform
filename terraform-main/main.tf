...
module "ec2" {
    ...
    pub1_sub_id = module.vpc.pub1_sub_id
    pub2_sub_id = module.vpc.pub2_sub_id
    my_vpc_sg_id = module.sg.my_vpc_sg_id
}    
module "alb" {
    source = "./modules/alb"
 ...
 pub1_sub_id = module.vpc.pub1_sub_id
    pub2_sub_id = module.vpc.pub2_sub_id
    my_vpc_sg_id = module.sg.my_vpc_sg_id
    pub1_ec2_id = module.ec2.pub1_ec2_id
   pub2_ec2_id = module.ec2.pub2_ec2_id
...
module "rds" {
  ...
  pri1_sub_id = module.vpc.pri1_sub_id
  pri2_sub_id = module.vpc.pri2_sub_id
}
